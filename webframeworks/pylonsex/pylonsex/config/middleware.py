...
from pylonsex.config.environment import load_environment
import pylonsex.lib.helpers
import pylonsex.lib.app_globals as app_globals
...
def make_app(global_conf, full_stack=True, **app_conf):
    ...
    config.init_app(global_conf, app_conf, package='pylonsex')
        
    # Load our default Pylons WSGI app and make g available
    app = pylons.wsgiapp.PylonsApp(config, helpers=pylonsex.lib.helpers,
